{{--
    Kop surat semua cetakan Nafsul: logo unit di kiri, identitas rumah sakit
    RATA KIRI di sebelahnya. Ukuran hurufnya (`.kop-nama`, `.kop-unit`,
    `.kop-alamat`) tetap milik lembar masing-masing, sedangkan tata letak
    logonya ada di `pdf.partials.kop_nafsul_style`.
